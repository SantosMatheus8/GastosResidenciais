...
export default function Home() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] text-center">
      <h1 className="text-5xl font-extrabold text-indigo-600 mb-2">ResiGa</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 w-full max-w-3xl">
        ...
        >
          ...
          <span className="font-semibold text-gray-800">Pessoas</span>
          <span className="text-xs text-gray-400">Gerenciar pessoas</span>
        </Link>
        ...
        >
          ...
          <span className="text-xs text-gray-400">Gerenciar categorias</span>
        </Link>
        ...
        >
          ...
          <span className="font-semibold text-gray-800">Transações</span>
          <span className="text-xs text-gray-400">Gerenciar transações</span>
        </Link>
        ...
        >
          ...
          <span className="font-semibold text-gray-800">Totais por Pessoa</span>
          <span className="text-xs text-gray-400">Dashboard financeiro</span>
        </Link>
        ...
        >
          ...
          <span className="font-semibold text-gray-800">Totais por Categoria</span>
          <span className="text-xs text-gray-400">Dashboard financeiro</span>
        </Link>
      </div>
    </div>
